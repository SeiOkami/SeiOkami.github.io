...
* Люблю создавать необычные инструменты. Например: 
  * [Управление платформенными обработками](https://infostart.ru/public/1527932/?ref=1159) - расширение для извлечения и автоматической подмены встроенных в платформу обработок (консоль запросов, журнал регистрации и так далее) 
  * [Менеджер открытых форм](https://infostart.ru/public/610324/?ref=1159) - обработка для перехвата открытых окон для анализа и изменения их свойств и данных
  * [Конструктор внешних печатных форм](https://infostart.ru/public/162019/?ref=1159) - мой первый эксперимент, который позволял в несколько кликов получить внешнюю обработку с выбранной типовой печатной формой
* Люблю изучать платформу на прочность, а результаты исследований публиковать в [телеграм канале Желтый Чайник 1С](https://t.me/JuniorOneS)
...
Ради эксперимента я решил сделать свой "фреймворк" на 1С и выбрал для этого неисследованную тему - [построение произвольного меню внутри поля глобального поиска](https://infostart.ru/public/1833872/?ref=1159).
...
Подробнее ознакомиться можно на [странице проекта](https://github.com/SeiOkami/AdvancedGlobalSearchOneS).
...
* **Проблемы мультиязычной разработки** - на этапе разработки мы ещё не обо все стены ударились, поэтому платформа готовит для нас сюрпризы
  ...
  * **Поставка с разным составом языков**. Теперь из разных веток можно создавать разные варианты расширения. Они будут отличаться только отсутствием "лишнего" языка в дереве метаданных. Такие расширения будет легче применить конечному потребителю.  
  ![Поставка с разным составом языков](44.png)  
...
**Ссылка на фреймворк [Расширенный глобальный поиск](https://github.com/SeiOkami/AdvancedGlobalSearchOneS)**

TODO: Понравилась статья? Ссылки...